...
const detailElements = document.querySelectorAll('.project-card-button-detail');


detailElements.forEach((button) => {
    button.addEventListener('click', () => {
    let container = button.closest(".project-card-container");
    ...
    let cardheading = container.querySelector(".project-card-link");
    ...
    let cardtechstack = container.querySelector('.project-card-techstack-container');
    modaltechstackcontainer.innerHTML = cardtechstack.innerHTML;

    let carddesc = container.querySelector(".project-card-desc");
