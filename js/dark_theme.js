(function () {
    ...
    function applyTheme(theme) {
        ...
        document
            .querySelectorAll('.theme-toggle, .hero-btn, .nav-mobile-toggle, .reel-wrap, .card, .btn-danger, .btn-success, .problem-canvas, .answer-box, #btn-again-after-problem, #btn-reveal' )
            .forEach((element) => {
