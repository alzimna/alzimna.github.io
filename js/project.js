...
async function loadProjects() {
    try {
        ...
        const projectList = document.querySelector(".project-cards-container")
        ...
        for (let i = 0; i < projects.length; i++) {
            ...
            projectItem.classList.add("swiper-slide", "project-card-container");
            ...
            projectDesc.classList.add("project-card-desc");
            ...
            setAttributes(projectFooterPreviewButton,{
                ...
                "class" : "project-card-button-preview fw-medium",
                "type" : "button"});
            ...
            setAttributes(projectFooterPreviewIcon,{
                "class" : "project-card-button-icon fa-solid fa-eye"
            });
